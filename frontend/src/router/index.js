...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'records/:id', name: 'record-detail', component: () => import('../views/RecordDetailPage.vue'), meta: { title: '随记详情' } },
      ...
      { path: 'shared-calendar', name: 'shared-calendar', component: () => import('../views/SharedCalendar.vue'), meta: { title: '好友日历' } },
      { path: 'shared-calendar/:userId', name: 'shared-calendar-detail', component: () => import('../views/SharedCalendar.vue'), meta: { title: '好友日历' } },
